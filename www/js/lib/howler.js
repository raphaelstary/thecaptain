...
(function () {
    ...
    HowlerGlobal.prototype = {
        ...
        _enableMobileAudio: function () {
            ...
            var isTouch = !!(('ontouchend' in window) || (self._navigator && self._navigator.maxTouchPoints > 0) ||
    ...
    var setupAudioContext = function () {
        ...
        if (Howler.usingWebAudio) {
            Howler.masterGain = (typeof Howler.ctx.createGain === 'undefined') ? Howler.ctx.createGainNode() :
                Howler.ctx.createGain();
            ...
            if (typeof args[0] === 'object') {
                ...
                if (typeof id === 'undefined') {
                    self._pannerAttr = {
                        ...
                        coneOuterAngle: typeof o.coneOuterAngle !== 'undefined' ? o.coneOuterAngle :
