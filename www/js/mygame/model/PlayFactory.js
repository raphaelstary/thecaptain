G.PlayFactory = (function (Grid, GridHelper, GridViewHelper, DomainGridHelper, World, WorldView, PlayerController, zero,
    ...
    return {
        createWorld: function (stage, timer, device, map, npcInfo, wallInfo, backgroundInfo, directions, gameEvents,
            ...
            return new World(worldView, domainGridHelper, camera, timer, directions, gameEvents, npcInfo, flags, gameCallbacks, possibleInteractionStart, possibleInteractionEnd, interaction, fight, showMenu, endMap, prevMapKey, pause, resume);
        },
